...
public class QLSinhVien extends javax.swing.JFrame {
    ...
    public QLSinhVien() {
        ...
        this.listSV.add(new SinhVien("PH1", "A", "Nam", "Java"));
        this.listSV.add(new SinhVien("PH2", "B", "Nu", "UDPM"));
        this.listSV.add(new SinhVien("PH3", "C", "Nam", "XLDL"));
    ...
    private void initComponents() {
        ...
        tblSV.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã SV", "Họ Tên", "Giới tính", "C/Ngành"
            }
        ));
